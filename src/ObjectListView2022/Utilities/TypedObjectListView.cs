...
namespace BrightIdeasSoftware.Utilities
{
    ...
    public class TypedObjectListView<T> where T : class
    {
        ...
        public virtual TypedColumn<T> GetColumn(int i) => new TypedColumn<T>(olv.GetColumn(i));
        ...
        /// <returns>A typed column or null</returns>
        public virtual TypedColumn<T> GetColumn(string name) => new TypedColumn<T>(olv.GetColumn(name));
        ...
        public virtual T GetModelObject(int index) => (T)olv.GetModelObject(index);
