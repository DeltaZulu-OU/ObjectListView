...
namespace BrightIdeasSoftware.SubControls
{
    ...
    public class ToolTipControl : NativeWindow
    {
        ...
        private readonly bool hasBorder = true;
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnShowing(ToolTipShowingEventArgs e) => Showing?.Invoke(this, e);

        /// <summary>
        ///
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnPop(EventArgs e) => Pop?.Invoke(this, e);
