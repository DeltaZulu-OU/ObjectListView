...
namespace BrightIdeasSoftware
{
    ...
    public partial class OLVColumn : ColumnHeader
    {
        ...
        /// </summary>
        [Browsable(false)]
        public bool HasHeaderImage => (ListView != null &&
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual ColumnButtonRenderer CreateColumnButtonRenderer() => new ColumnButtonRenderer();
        ...
        /// <param name="rowObject"></param>
        /// <returns></returns>
        public string GetStringValue(object rowObject) => ValueToString(GetValue(rowObject));
        ...
        /// </summary>
        public virtual void OnVisibilityChanged(EventArgs e) => VisibilityChanged?.Invoke(this, e);
        ...
        public void MakeGroupies(object[] values, string[] descriptions) => MakeGroupies(values, descriptions, null, null, null);
        ...
        /// <param name="values"></param>
        /// <param name="descriptions"></param>
        public void MakeGroupies<T>(T[] values, string[] descriptions) => MakeGroupies(values, descriptions, null, null, null);
        ...
        public void MakeGroupies<T>(T[] values, string[] descriptions, object[] images) => MakeGroupies(values, descriptions, images, null, null);
        ...
        public void MakeGroupies<T>(T[] values, string[] descriptions, object[] images, string[] subtitles) => MakeGroupies(values, descriptions, images, subtitles, null);
